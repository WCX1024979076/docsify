...
For two 01 Squares X,Y , we deﬁne two operators X × Y and X![img](http://picup.tim-wcx.ltd/img/20210927182635.jpeg)Y . The value of them are also 01 Square matrices and calculated below(we use Z to abbreviate X × Y and D to abbreviate X![img](http://picup.tim-wcx.ltd/img/20210927182640.jpeg)Y ):

![img](http://picup.tim-wcx.ltd/img/20210927180110.jpeg)
...
![在这里插入图片描述](http://picup.tim-wcx.ltd/img/20210927180443.jpeg)

对于每一个方程组系数矩阵，如果秩为k，则$C_k,C_{K+1} .... C_n$，可以任意选择0和1，则对应答案为$2^{n-k}$，最后将每一列的答案乘起来即为答案。

![在这里插入图片描述](http://picup.tim-wcx.ltd/img/20210927182240.png)
