...
![img](https://pic.tim-wcx.ltd/img/20210208132917.png)
...
1. 将第s1加入图中，如图，增加的权值为dis[s1]
   ...
   ![img](https://pic.tim-wcx.ltd/img/20210208133733.png)

2. 将s2加入图中，假如s1和s2的最小公共祖先为fa1即为lca(s1,s2)，则增加的权值为dis[s2]-dis[fa1]

![image-20210208133953025](https://pic.tim-wcx.ltd/img/20210208133953.png)

3. 将s3加入图中，假设s1和s3的最小公共祖先为fa2，s2和s3的最小公共最先为fa1，假设fa1的深度小于fa2的深度，则增加的权值为dis[s3]-dis[fa2]

   ![img](https://pic.tim-wcx.ltd/img/20210208134258.png)
...
##### ![img](https://pic.tim-wcx.ltd/img/20210208134601.png) 题解
...
![image-20210208135020340](https://pic.tim-wcx.ltd/img/20210208135020.png)
